...
public class enemycontroller : MonoBehaviour
{
    ...
    void PlayerInputs()
    {
        playerInput.x = Input.GetAxis("Horizontalenemy");
        playerInput.y = Input.GetAxis("Verticalenemy");
        ...
        desiredJump |= Input.GetButtonDown("Jumpenemy");
        desiresClimbing = Input.GetButton("Climbenemy");
    }
